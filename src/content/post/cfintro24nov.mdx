...
- **Watch/Listen to the corresponding recording *before* each live session**
  ...
  - Recordings and slides will be made available 7 days *before* the live sessions (the recording for the first session on Nov 13 will be available from Thursday, Nov 7)
...
- Week 1: **Session 1 - Introduction Course: Q&A and guided practice**
  - *from Nov 7: Watch the 1st recording in preparation for the live session*
...
- Week 3: **Session 2 - Introduction Course: Q&A and guided practice**
  - *from Nov 21: Watch the 2nd recording in preparation for the live session*
...
- Week 4: **Session 3 - Introduction Course: Q&A and guided practice**
  - *from Nov 28: Watch the 3rd recording in preparation for the live session*
...
- Week 5: **Session 4 - Introduction Course: Q&A and guided practice**
  - *from Dec 5: Watch the 4th recording in preparation for the live session*
...
<CallToAction
    ...
    actions={[
      ...
      { text: 'Access Course Materials (requires registration)', href: 'https://community.convergentfacilitation.org/c/your-courses/cfintro24nov/18', icon: 'tabler:books' },
    ]}
  />
