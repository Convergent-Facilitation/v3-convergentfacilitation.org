...
This course is the second iteration of an in depth introduction to Convergent Facilitation - a powerful approach to facilitating collaborative decision making. It holds massive potential for those working to bring communities, stakeholders and movements together to address our most challenging problems. 
...
The weekly Q&A and practice sessions will consist of a brief recap of the content of each recording, space to ask questions to Verene or Paul (depending on which group you will join), and practice in small groups. 

The Q&A and practice sessions will be run by Paul Kahawatte and Verene Nicolas, who are both leading practitioners of Convergent Facilitation, supported by CF practice group facilitators.
