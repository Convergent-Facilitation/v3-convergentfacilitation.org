...
We offer this course as gift. This mean we do not want that anyone gives anything *in return* to participate in this course.
...
<CallToAction
    ...
    subtitle="You are also being invited to give during the registration process. We are sharing this here if you want to make an (additional) contribution outside the registration process."
    actions={[
	  {
        variant: 'primary',
